...
//		if(DEBUG)		/*$debug$*/
//			Log.d(TAG, "child : " + child.getClass().getName() + ", index : " + index);		/*$debug$*/
...
//		if(DEBUG)		/*$debug$*/
//			Log.d(TAG, "setCheckedId : id = " + id);		/*$debug$*/
...
//		if(DEBUG)		/*$debug$*/
//			Log.d(TAG, "setCheckedStateForView : id = " + viewId + ", checked = " + checked);		/*$debug$*/		
...
//			if(DEBUG) {		/*$debug$*/
//				Log.d(TAG, "mCheckedId = " + mCheckedId);		/*$debug$*/
//				Log.d(TAG, "mProtectFromCheckedChange = " + mProtectFromCheckedChange);		/*$debug$*/
//			}		/*$debug$*/
...
//			if(DEBUG)		/*$debug$*/
//				Log.d(TAG, "onChildViewAdded : parent = " + parent + ", child = " + child);		/*$debug$*/
			...
			if(parent == TableRadioGroup.this && child instanceof TableRow) {
				...
				for(int j = 0; j < row.getChildCount(); j++){
					View vv = row.getChildAt(j);
//					Log.d(TAG, "vv : " + vv.getClass().getName() + ", index : " + j);		/*$debug$*/
...
//			if(DEBUG)		/*$debug$*/
//				Log.d(TAG, "onChildViewRemoved : parent = " + parent + ", child = " + child);		/*$debug$*/
